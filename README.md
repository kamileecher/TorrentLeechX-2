...
|`/gleecharchive` | This command will compress the folder/file and will upload to your cloud.
| `/leechextract`| This will unarchive file and dupload to telegram.
|`/gleechextract`| This will unarchive file and upload to cloud.
...
## 🔧Commands to be set via Botfather (will only work if you set mentions from custom cmds).
    ...
    gleecharchive - leech any torrent/magnet/direct-download link to Cloud and Upload It as .tar.gz acrhive...
    gleechextract - This will unarchive file and upload to cloud.
    getsize - This will give you total size of your destination folder in cloud.
